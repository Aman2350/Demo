...
export default function Footer() {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-teal-100 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                </svg>
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-teal-100 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-teal-100 hover:text-white transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/shipping" className="text-teal-100 hover:text-white transition-colors">
                  Shipping Policy
                </Link>
              </li>
              <li>
  ...
  <ul className="space-y-2">
    <li className="flex items-start space-x-2">
      ...
      <a
        href="https://www.google.com/maps/search/?api=1&query=27.552990,76.634570"
        target="_blank"
  ...
  <div className="flex items-start space-x-2">
    <svg
      className="w-5 h-5 mt-1 text-teal-100"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
